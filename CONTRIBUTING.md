...
Thank you for supporting the [`warehouse`](https://thomasweise.github.io/warehouse).
...
Our [make build](https://thomasweise.github.io/warehouse/Makefile.html) requires the code to pass the checks of more than 20 tools.
This may make it complicated to submit code contributions via git pull requests.

The preferred way to contribute to this project therefore is by opening [issues](https://github.com/thomasWeise/warehouse/issues).

If you nevertheless submit a git pull or otherwise code-based contribution, then it should ideally pass all these checks.
In other words, the [make build](https://thomasweise.github.io/warehouse/Makefile.html) requires the code to pass the checks of more than 20 tools should succeed on your local system.
...
If your contribution concerns the *security* of `warehouse`, please consider our [security policy](https://thomasweise.github.io/warehouse/SECURITY_md.html).


## 2. License

`warehouse` is provided to the public as open source software under the [GNU GENERAL PUBLIC LICENSE, Version 3, 29 June 2007](https://thomasweise.github.io/warehouse/LICENSE.html).
...
Unless you explicitly state otherwise, any contribution intentionally submitted for inclusion in `warehouse` by you shall be under the above license, terms, and conditions, without any additional terms or conditions.
